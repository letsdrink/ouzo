...
class View
{
    ...
    {
        $helperPath = Path::join(ROOT_PATH, AutoloadPaths::getViewPath(), $this->_viewName . '.helper.php');
        Files::loadIfExists($helperPath);

        $viewPath = Path::join(ROOT_PATH, AutoloadPaths::getViewPath(), $this->_viewName . '.phtml');
    ...
    private function _loadHelpers()
    {
        ...
        $appHelperPath = Path::join(ROOT_PATH, AutoloadPaths::getHelperPath(), 'ApplicationHelper.php');
        $formHelperPath = Path::join('Helper', 'FormHelper.php');
        $urlHelperPath = Path::join(ROOT_PATH, AutoloadPaths::getHelperPath(), 'UrlHelper.php');
